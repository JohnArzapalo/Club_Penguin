...
public class EjemplarDAOImpl extends DAOImplBase implements EjemplarDAO {
    ...
    protected void instanciarObjetoDelResultSet() throws SQLException {
        // Necesitarías implementar MaterialDAO y BibliotecaDAO para cargar estos objetos
        ...
        // ejemplar.setMaterial(...); // Deberías cargar el material completo
        // ejemplar.setBiblioteca(...); // Deberías cargar la biblioteca completa
