...
using bibliotecaDTO = SoftInvWAProg3.BibliotecaWS.bibliotecaDTO;
using materialBibliotecaDTO = SoftInvWAProg3.MaterialWS.bibliotecaDTO;
    ...
    public partial class materiales : System.Web.UI.Page
    {
        ...
        protected void btnBusquedaAvanzadaServidor_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                materialBibliotecaDTO BibliotecaDTO = new materialBibliotecaDTO(); // Cambiar al tipo correcto
