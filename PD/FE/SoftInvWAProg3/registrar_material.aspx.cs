...
namespace SoftInvWAProg3
{
    public partial class registrar_material : Page
    {
        ...
        private void CargarEjemplaresDesdeViewState(List<ejemplarDTO> valores = null)
        {
            List<bibliotecaDTO> bibliotecas = new List<bibliotecaDTO>(bibliotecaCliente.listarBibliotecas());
            ...
            for (int i = 1; i <= CantidadEjemplares; i++)
            {
                ...
                ddlEstado.Items.Add(new ListItem("Disponible", estadoEjemplar.DISPONIBLE.ToString()));
                ddlEstado.Items.Add(new ListItem("Prestado", estadoEjemplar.PRESTADO.ToString()));
                ddlEstado.Items.Add(new ListItem("En reparación", estadoEjemplar.EN_REPARACION.ToString()));
                ...
                {
                    ddlEstado.SelectedValue = estadoEjemplar.DISPONIBLE.ToString();
                }
        ...
        private void AgregarEjemplarUI(int index, List<bibliotecaDTO> bibliotecas, bool soloUno)
        {
            Panel panel = new Panel { CssClass = "ejemplar-block" };
        ...
        {
            List<ejemplarDTO> lista = new List<ejemplarDTO>();
            for (int i = 1; i <= CantidadEjemplares; i++)
            {
                ...
                {
                    ej.biblioteca = new bibliotecaDTO
                    {
                ...
                {
                    ej.estado = (estadoEjemplar)Enum.Parse(typeof(estadoEjemplar), estado);
                }
