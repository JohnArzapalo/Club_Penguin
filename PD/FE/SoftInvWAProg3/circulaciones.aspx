...
<asp:Content ID="MainContent" ContentPlaceHolderID="MainContent" runat="server">
            ...
            <div class="row g-3 mt-3">
                ...
                <div class="col-md-6">
                    <asp:DropDownList ID="ddlEstado" CssClass="form-select" runat="server" style="width: 100%;">
                        ...
                        <asp:ListItem Text="Devuelto con retraso y daño/pérdida" Value="DEVUELTO_RETRASO_Y_DANO_PERDIDA" />
   ...
   <%--             <asp:GridView ID="gvCirculaciones" CssClass="table table-striped table-hover" runat="server" 
                    AutoGenerateColumns="false" 
                    AllowPaging="true" 
                    PageSize="10" 
                    OnPageIndexChanging="gvCirculaciones_PageIndexChanging">
                    <Columns>
                ...
                <asp:GridView ID="gvCirculaciones" runat="server" 
                    AutoGenerateColumns="False"
                    CssClass="table table-bordered table-hover"
                    OnRowCommand="gvCirculaciones_RowCommand"
                    OnRowDataBound="gvCirculaciones_RowDataBound"
                    DataKeyNames="circulacionId"
                    EnableViewState="false">
                    <Columns>
                        <asp:BoundField DataField="circulacionId" HeaderText="Circulación" />
                        <asp:BoundField DataField="reserva.reservaId" HeaderText="Reserva" />
				        <asp:BoundField DataField="usuario.usuarioId" HeaderText="Usuario" />
				        <asp:BoundField DataField="ejemplar.ejemplarId" HeaderText="Ejemplar" />
                        <asp:BoundField DataField="fechaPrestamo" HeaderText="Fecha préstamo" DataFormatString="{0:dd/MM/yyyy}" />
                        <asp:BoundField DataField="fechaDevolucion" HeaderText="Fecha devolución" DataFormatString="{0:dd/MM/yyyy}" NullDisplayText="No devuelto"/>
                        <asp:BoundField DataField="estadoPrestamo" HeaderText="Estado" />
        
                        <asp:TemplateField ItemStyle-CssClass="d-none" HeaderStyle-CssClass="d-none">
                            <ItemTemplate>
                                <asp:LinkButton runat="server" 
                                    CommandName="VerDetalleCirculacion" 
                                    CommandArgument='<%# Eval("circulacionId") %>'
        ...
        <asp:Literal ID="ltDEBUGEANDOOOO" runat="server" />
    </div>
</asp:Content>
